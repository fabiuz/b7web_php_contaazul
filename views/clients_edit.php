...
<form method="POST">
    ...
    <input type="text" name="name"
           value="<?php echo $client_info['name']; ?>"
           required/><br/><br/>
    ...
    <input name="phone" value="<?php echo $client_info['phone']; ?>"
    /><br/><br/>
...
<script type="text/javascript"
        src="<?php echo BASE_URL; ?>/assets/js/script_clients_add.js"></script>